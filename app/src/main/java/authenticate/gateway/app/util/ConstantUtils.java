...
public class ConstantUtils {
    ...
    public static final String MONGO_API_APP_ID = "APPID";
    public static final String MONGO_API_APP_KEY = "APIKEY";
    public static final String MONGO_API_DATASOURCE = "DATASOURCE";
